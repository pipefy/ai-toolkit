...
| **iPaaS usage health** | [pipefy-ipaas-usage-health](ipaas/pipefy-ipaas-usage-health/SKILL.md) | Org briefing: iPaaS adoption, flow-run failures, noisy pipes, vs native usage and AI credits. 10 MCP tools. |
